...
const resolveFetch$3 = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter$e(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(function () { return nodePonyfill; })).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
} (nodePonyfill$1, nodePonyfillExports));

var crossFetch = nodePonyfillExports;
...
class PostgrestBuilder {
    ...
    then(onfulfilled, onrejected) {
        ...
        let res = _fetch(this.url.toString(), {
            ...
            signal: this.signal,
        }).then((res) => __awaiter$c(this, void 0, void 0, function* () {
            var _a, _b, _c;
            let error = null;
            let data = null;
            let count = null;
...
utils$3.BufferingLogger = function createBufferingLogger(identifier, uniqueID) {
    var logFunction = srcExports(identifier);
...
FastBufferListExports.BufferList = BufferList$1; // backwards compatibility
...
var debug = srcExports('websocket:server');
...
const resolveFetch$2 = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter$9(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(function () { return nodePonyfill; })).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
const resolveResponse = () => __awaiter$9(void 0, void 0, void 0, function* () {
    if (typeof Response === 'undefined') {
        return (yield Promise.resolve().then(function () { return nodePonyfill; })).Response;
    }
    return Response;
});
...
const resolveHeadersConstructor = () => {
    if (typeof Headers === 'undefined') {
        return nodePonyfillExports.Headers;
    }
    return Headers;
};
...
const resolveFetch = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter$4(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(function () { return nodePonyfill; })).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
export { POST };
//# sourceMappingURL=_server-ca155d14.js.map
